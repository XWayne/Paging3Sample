...
class HelloWorldViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
...
class HelloWorldAdapter : PagingDataAdapter<Message, HelloWorldViewHolder>(diffCallback) {
